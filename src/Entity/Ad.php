...
class Ad
{
     ...
     * @Assert\Length(min=10,max=255,minMessage="Le titre doit faire + de 10 caractères",maxMessage="Votre titre est trop long, pas plus de 255 caractères")
     */
    private $title;
    ...
    /**
     * Création d'un fonction pour permettre d'initialiser le slug (avant la persistance et avant la maj)
     * 
     * @ORM\PrePersist
     * @ORM\PreUpdate
     * 
    ...
    public function getAverageRatings(){
        ...
        $sum = array_reduce($this->comments->toArray(),function($total,$comment){
            // on retourne le total + la onte de chaque commentaires
